...
namespace math
{
	std::optional<float> ray::intersect_bounds(vector_3d const& min,
											   vector_3d const& max) const
	{
	...
	std::optional<float> ray::intersect_triangle(vector_3d const& v0,
												 vector_3d const& v1,
												 vector_3d const& v2) const
	{
