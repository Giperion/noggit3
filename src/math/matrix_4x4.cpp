...
namespace math
{
	...
	vector_4d matrix_4x4::operator*(const vector_4d& v) const
	{
		return {_m[0][0] * v[0] + _m[0][1] * v[1] + _m[0][2] * v[2] +
				...
				_m[2][0] * v[0] + _m[2][1] * v[1] + _m[2][2] * v[2] +
					_m[2][3] * v[3],
				_m[3][0] * v[0] + _m[3][1] * v[1] + _m[3][2] * v[2] +
					_m[3][3] * v[3]};
	}

	matrix_4x4 matrix_4x4::operator*(matrix_4x4 const& other) const
	{
		return {_m[0][0] * other._m[0][0] + _m[0][1] * other._m[1][0] +
					_m[0][2] * other._m[2][0] + _m[0][3] * other._m[3][0],
				_m[0][0] * other._m[0][1] + _m[0][1] * other._m[1][1] +
					_m[0][2] * other._m[2][1] + _m[0][3] * other._m[3][1],
				_m[0][0] * other._m[0][2] + _m[0][1] * other._m[1][2] +
					_m[0][2] * other._m[2][2] + _m[0][3] * other._m[3][2],
				_m[0][0] * other._m[0][3] + _m[0][1] * other._m[1][3] +
					_m[0][2] * other._m[2][3] + _m[0][3] * other._m[3][3],
				_m[1][0] * other._m[0][0] + _m[1][1] * other._m[1][0] +
					_m[1][2] * other._m[2][0] + _m[1][3] * other._m[3][0],
				_m[1][0] * other._m[0][1] + _m[1][1] * other._m[1][1] +
					_m[1][2] * other._m[2][1] + _m[1][3] * other._m[3][1],
				_m[1][0] * other._m[0][2] + _m[1][1] * other._m[1][2] +
					_m[1][2] * other._m[2][2] + _m[1][3] * other._m[3][2],
				_m[1][0] * other._m[0][3] + _m[1][1] * other._m[1][3] +
					_m[1][2] * other._m[2][3] + _m[1][3] * other._m[3][3],
				_m[2][0] * other._m[0][0] + _m[2][1] * other._m[1][0] +
					_m[2][2] * other._m[2][0] + _m[2][3] * other._m[3][0],
				_m[2][0] * other._m[0][1] + _m[2][1] * other._m[1][1] +
					_m[2][2] * other._m[2][1] + _m[2][3] * other._m[3][1],
				_m[2][0] * other._m[0][2] + _m[2][1] * other._m[1][2] +
					_m[2][2] * other._m[2][2] + _m[2][3] * other._m[3][2],
				_m[2][0] * other._m[0][3] + _m[2][1] * other._m[1][3] +
					_m[2][2] * other._m[2][3] + _m[2][3] * other._m[3][3],
				_m[3][0] * other._m[0][0] + _m[3][1] * other._m[1][0] +
					_m[3][2] * other._m[2][0] + _m[3][3] * other._m[3][0],
				_m[3][0] * other._m[0][1] + _m[3][1] * other._m[1][1] +
					_m[3][2] * other._m[2][1] + _m[3][3] * other._m[3][1],
				_m[3][0] * other._m[0][2] + _m[3][1] * other._m[1][2] +
					_m[3][2] * other._m[2][2] + _m[3][3] * other._m[3][2],
				_m[3][0] * other._m[0][3] + _m[3][1] * other._m[1][3] +
	...
	{
		return apply(
			[&](math::vector_3d const& point) { return *this * point; },
			points);
	}
...
#define SUB(a, b) (s[1][a] * s[2][b] - s[2][a] * s[1][b])
			return s[0][0] * SUB(1, 2) - s[0][1] * SUB(0, 2) +
				   s[0][2] * SUB(0, 1);
#undef SUB
		}
	}  // namespace
	...
	{
		return {minor_size(*this, 0, 0),  -minor_size(*this, 0, 1),
				minor_size(*this, 0, 2),  -minor_size(*this, 0, 3),
				-minor_size(*this, 1, 0), minor_size(*this, 1, 1),
				-minor_size(*this, 1, 2), minor_size(*this, 1, 3),
				minor_size(*this, 2, 0),  -minor_size(*this, 2, 1),
				minor_size(*this, 2, 2),  -minor_size(*this, 2, 3),
				-minor_size(*this, 3, 0), minor_size(*this, 3, 1),
				-minor_size(*this, 3, 2), minor_size(*this, 3, 3)};
	}
	...
	matrix_4x4& matrix_4x4::operator/(float f) { return *this * (1 / f); }
...
#define SUB(a, b) (mat(2, a) * mat(3, b) - mat(3, a) * mat(2, b))
			return mat(0, 0) * (mat(1, 1) * SUB(2, 3) - mat(1, 2) * SUB(1, 3) +
								mat(1, 3) * SUB(1, 2)) -
				   mat(0, 1) * (mat(1, 0) * SUB(2, 3) - mat(1, 2) * SUB(0, 3) +
								mat(1, 3) * SUB(0, 2)) +
				   mat(0, 2) * (mat(1, 0) * SUB(1, 3) - mat(1, 1) * SUB(0, 3) +
								mat(1, 3) * SUB(0, 1)) -
				   mat(0, 3) * (mat(1, 0) * SUB(1, 2) - mat(1, 1) * SUB(0, 2) +
								mat(1, 2) * SUB(0, 1));
#undef SUB
		}
	}  // namespace
	...
	{
		return {_m[0][0], _m[1][0], _m[2][0], _m[3][0], _m[0][1], _m[1][1],
				_m[2][1], _m[3][1], _m[0][2], _m[1][2], _m[2][2], _m[3][2],
