	...
	namespace scoped
	{
		...
		class index_buffer_manual_binder
		{
		   public:
			...
			index_buffer_manual_binder(index_buffer_manual_binder const&) =
				delete;
			index_buffer_manual_binder(index_buffer_manual_binder&&) = delete;
			index_buffer_manual_binder& operator=(
				index_buffer_manual_binder const&) = delete;
			index_buffer_manual_binder& operator=(
				index_buffer_manual_binder&&) = delete;
		...
		class deferred_upload_buffers
		{
		   public:
			...
			deferred_upload_buffers& operator=(deferred_upload_buffers const&) =
				delete;
			deferred_upload_buffers& operator=(deferred_upload_buffers&&) =
				delete;
		...
		class deferred_upload_vertex_arrays
		{
		   public:
			...
			deferred_upload_vertex_arrays(
				deferred_upload_vertex_arrays const&) = delete;
			deferred_upload_vertex_arrays(deferred_upload_vertex_arrays&&) =
				delete;
			deferred_upload_vertex_arrays& operator=(
				deferred_upload_vertex_arrays const&) = delete;
			deferred_upload_vertex_arrays& operator=(
				deferred_upload_vertex_arrays&&) = delete;
