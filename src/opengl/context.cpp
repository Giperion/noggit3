...
namespace opengl
{
	namespace
	{
		...
		template <>
		struct extension_traits<QOpenGLExtension_ARB_vertex_program>
		{
		...
		struct verify_context_and_check_for_gl_errors
		{
			...
			verify_context_and_check_for_gl_errors(
				QOpenGLContext* current_context, char const* function,
				  ...
				  _extra_info(extra_info)
			{
				if (!_current_context)
				{
					throw std::runtime_error(std::string(_function) +
											 ": called without active OpenGL "
				...
				if (!_current_context->isValid())
				{
					throw std::runtime_error(
						...
						": called without active OpenGL context: invalid");
				}
			...
			verify_context_and_check_for_gl_errors(
				...
				: verify_context_and_check_for_gl_errors(
					  ...
					  &verify_context_and_check_for_gl_errors::no_extra_info)
			{
			}
			...
			Functions* version_functions() const
			{
				...
				if (!f)
				{
					throw std::runtime_error(
						std::string(_function) +
						": requires OpenGL functions for version " +
						typeid(Functions).name());
				}
				return f;
			}
			template <typename Extension>
			...
			{
				if (!_current_context->hasExtension(
						extension_traits<Extension>::name))
				{
					throw std::runtime_error(std::string(_function) +
			...
			verify_context_and_check_for_gl_errors(
				verify_context_and_check_for_gl_errors const&) = delete;
			verify_context_and_check_for_gl_errors(
				verify_context_and_check_for_gl_errors&&) = delete;
			verify_context_and_check_for_gl_errors& operator=(
				verify_context_and_check_for_gl_errors const&) = delete;
			verify_context_and_check_for_gl_errors& operator=(
				verify_context_and_check_for_gl_errors&&) = delete;
		};
	...
	context::scoped_setter::scoped_setter(context& context_,
		  ...
		  _old_core_func(context_._3_3_core_func)
	{
		...
		_context._3_3_core_func =
			current_context->versionFunctions<QOpenGLFunctions_3_3_Core>();

		if (!_context._3_3_core_func)
		{
			throw std::runtime_error(
				"Noggit requires OpenGL 3.3 core functions");
		}
	}
	...
	context::save_current_context::save_current_context(context& context_)
		: _is_current(context_._current_context &&
					  QOpenGLContext::currentContext() ==
						  context_._current_context),
		  _gl_context(!_is_current ? nullptr : context_._current_context),
		  _surface(!_is_current ? nullptr
								: context_._current_context->surface())
	{
		if (_is_current)
		{
	...
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
							 ...
							 GLenum format, GLenum type, GLvoid* data)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glReadPixels(x, y, width, height,
														   format, type, data);
	}
							 ...
							 GLenum format, GLenum type, GLvoid const* data)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glTexImage2D(
			target, level, internal_format, width, height, border, format, type,
			data);
	}
	void context::compressedTexImage2D(GLenum target, GLint level,
									   ...
									   GLsizei imageSize, GLvoid const* data)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glCompressedTexImage2D(
	...
	void context::texParameteri(GLenum target, GLenum pname, GLint param)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glTexParameteri(target, pname,
															  param);
	}
	void context::texParameterf(GLenum target, GLenum pname, GLfloat param)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glTexParameterf(target, pname,
															  param);
	}
	void context::texParameteriv(GLenum target, GLenum pname,
								 GLint const* params)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glTexParameteriv(target, pname,
															   params);
	}
	void context::texParameterfv(GLenum target, GLenum pname,
								 GLfloat const* params)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glTexParameterfv(target, pname,
															   params);
	}
	...
	void context::bufferData(GLenum target, GLsizeiptr size, GLvoid const* data,
							 GLenum usage)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glBufferData(target, size, data,
														   usage);
	}
							   ...
							   GLvoid const* indices)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glDrawElements(mode, count, type,
															 indices);
	}
	void context::drawElementsInstanced(GLenum mode, GLsizei count, GLenum type,
										GLvoid const* indices,
										GLsizei instancecount)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _3_3_core_func->glDrawElementsInstanced(mode, count, type,
													   indices, instancecount);
	}
	void context::drawRangeElements(GLenum mode, GLuint start, GLuint end,
									GLsizei count, GLenum type,
									GLvoid const* indices)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _3_3_core_func->glDrawRangeElements(mode, start, end, count,
												   type, indices);
	}
	...
	void context::genPrograms(GLsizei count, GLuint* programs)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _.extension_functions<QOpenGLExtension_ARB_vertex_program>()
			->glGenProgramsARB(count, programs);
	}
	void context::deletePrograms(GLsizei count, GLuint* programs)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _.extension_functions<QOpenGLExtension_ARB_vertex_program>()
			->glDeleteProgramsARB(count, programs);
	}
	...
	void context::programString(GLenum target, GLenum format, GLsizei len,
								GLvoid const* pointer)
	{
		verify_context_and_check_for_gl_errors const _(
			_current_context, __FUNCTION__, [this] {
				GLint error_position;
				getIntegerv(GL_PROGRAM_ERROR_POSITION_ARB, &error_position);
				return " at " + std::to_string(error_position) + ": " +
					   reinterpret_cast<char const*>(
						   getString(GL_PROGRAM_ERROR_STRING_ARB));
			});
		return _.extension_functions<QOpenGLExtension_ARB_vertex_program>()
			->glProgramStringARB(target, format, len, pointer);
	}
	void context::getProgramiv(GLuint program, GLenum pname, GLint* params)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glGetProgramiv(program, pname,
															 params);
	}
	void context::programLocalParameter4f(GLenum target, GLuint index,
	...
	void context::shaderSource(GLuint shader, GLsizei count,
							   GLchar const** string, GLint const* length)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glShaderSource(shader, count,
															 string, length);
	}
	...
	std::string context::get_program_info_log(GLuint program)
	{
		...
		_current_context->functions()->glGetProgramInfoLog(program, log.size(),
														   nullptr, log.data());
	...
	GLint context::getAttribLocation(GLuint program, GLchar const* name)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glGetAttribLocation(program,
																  name);
	}
									  ...
									  GLvoid const* pointer)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glVertexAttribPointer(
	...
	GLint context::getUniformLocation(GLuint program, GLchar const* name)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		auto val(
			_current_context->functions()->glGetUniformLocation(program, name));
		if (val == -1)
		{
	...
	void context::uniform1iv(GLint location, GLsizei count, GLint const* value)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glUniform1iv(location, count,
														   value);
	}

	void context::uniform2fv(GLint location, GLsizei count,
							 GLfloat const* value)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glUniform2fv(location, count,
														   value);
	}
	void context::uniform3fv(GLint location, GLsizei count,
							 GLfloat const* value)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glUniform3fv(location, count,
														   value);
	}
	void context::uniform4fv(GLint location, GLsizei count,
							 GLfloat const* value)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glUniform4fv(location, count,
														   value);
	}
	void context::uniformMatrix4fv(GLint location, GLsizei count,
								   GLboolean transpose, GLfloat const* value)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glUniformMatrix4fv(
	...
	void context::stencilOp(GLenum sfail, GLenum dpfail, GLenum dppass)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glStencilOp(sfail, dpfail,
														  dppass);
	}
	...
	void context::bindFramebuffer(GLenum target, GLuint framebuffer)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glBindFramebuffer(target,
																framebuffer);
	}
									   ...
									   GLint level)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glFramebufferTexture2D(
	...
	void context::bindRenderbuffer(GLenum target, GLuint renderbuffer)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glBindRenderbuffer(target,
																 renderbuffer);
	}
	void context::renderbufferStorage(GLenum target, GLenum internalformat,
									  GLsizei width, GLsizei height)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glRenderbufferStorage(
										  ...
										  GLuint renderbuffer)
	{
		verify_context_and_check_for_gl_errors const _(_current_context,
													   __FUNCTION__);
		return _current_context->functions()->glFramebufferRenderbuffer(
			target, attachment, renderbuffertarget, renderbuffer);
	}

	template <GLenum target>
	void context::bufferData(GLuint buffer, GLsizeiptr size, GLvoid const* data,
							 GLenum usage)
	{
		scoped::buffer_binder<target> const _(buffer);
		return bufferData(target, size, data, usage);
	}
	template void context::bufferData<GL_ARRAY_BUFFER>(GLuint buffer,
													   GLsizeiptr size,
													   GLvoid const* data,
													   GLenum usage);
	template void context::bufferData<GL_ELEMENT_ARRAY_BUFFER>(
		GLuint buffer, GLsizeiptr size, GLvoid const* data, GLenum usage);

	template <GLenum target, typename T>
	void context::bufferData(GLuint buffer, std::vector<T> const& data,
							 GLenum usage)
	{
		scoped::buffer_binder<target> const _(buffer);
	...
	template void context::bufferData<GL_ARRAY_BUFFER, float>(
		GLuint buffer, std::vector<float> const& data, GLenum usage);
	template void context::bufferData<GL_ARRAY_BUFFER, math::vector_2d>(
		GLuint buffer, std::vector<math::vector_2d> const& data, GLenum usage);
	template void context::bufferData<GL_ARRAY_BUFFER, math::vector_3d>(
		GLuint buffer, std::vector<math::vector_3d> const& data, GLenum usage);
	template void context::bufferData<GL_ARRAY_BUFFER, math::vector_4d>(
		GLuint buffer, std::vector<math::vector_4d> const& data, GLenum usage);
	template void context::bufferData<GL_ELEMENT_ARRAY_BUFFER, std::uint8_t>(
		GLuint buffer, std::vector<std::uint8_t> const& data, GLenum usage);
	template void context::bufferData<GL_ELEMENT_ARRAY_BUFFER, std::uint16_t>(
		GLuint buffer, std::vector<std::uint16_t> const& data, GLenum usage);
	template void context::bufferData<GL_ELEMENT_ARRAY_BUFFER, std::uint32_t>(
		GLuint buffer, std::vector<std::uint32_t> const& data, GLenum usage);

	void context::drawElements(GLenum mode, GLuint index_buffer, GLsizei count,
							   GLenum type, GLvoid const* indices)
	{
