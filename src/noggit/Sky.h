...
{
	int time;  // converted from hour:min to the 2880 half-minute ticks thing
			   // used in the other Sky thing

	float dayIntensity, nightIntensity, ambientIntensity, fogIntensity,
		fogDepth;
	math::vector_3d dayColor, nightColor, ambientColor, fogColor, dayDir,
		nightDir;
...
class Skies
{
   ...
   public:
	...
	std::vector<math::vector_3d> color_set =
		std::vector<math::vector_3d>(NUM_SkyColorNames);
