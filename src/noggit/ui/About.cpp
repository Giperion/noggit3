...
namespace noggit
{
	namespace ui
	{
		about::about(QWidget* parent) : QDialog(parent)
		{
			...
			icon->setPixmap(
				render_blp_to_pixmap("interface/icons/inv_potion_83.blp"));
			layout()->addWidget(icon);
			//! \todo was Skurri32
			layout()->addWidget(new QLabel("Noggit Studio", this));
			layout()->addWidget(
				new QLabel("a wow map editor for 3.3.5a", this));
			layout()->addWidget(
				new QLabel("Ufoz [...], Cryect, Beket, Schlumpf, "
						   "Tigurius, Steff, Garthog, Glararan, Cromon, "
						   "Hanfer, Skarn, AxelSheva, Valium, Kaev, "
						   "Adspartan",
						   this));
			layout()->addWidget(new QLabel(
				"World of Warcraft is (C) Blizzard Entertainment", this));
