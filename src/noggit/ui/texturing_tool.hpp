...
namespace noggit
{
	namespace ui
	{
		...
		{
		   public:
			texturing_tool(const math::vector_3d* camera_pos, World* world,
			...
			void paint(World* world, math::vector_3d const& pos, float dt,
		   ...
		   private:
			void change_tex_flag(World* world, math::vector_3d const& pos,
								 bool add,
								 scoped_blp_texture_reference texture);
