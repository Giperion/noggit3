...
namespace noggit
{
	namespace ui
	{
			...
			: QWidget(object_editor, Qt::Tool | Qt::WindowStaysOnTopHint)
		{
			...
			top_layout->addWidget(new QLabel(
				"Select a model to add.\nYou should select a chunk first.",
				this));
			...
			add_button("Disc 50 radius", "world/scale/50yardradiusdisc.m2", 1,
					   0);
			add_button("Disc 200 radius", "world/scale/200yardradiusdisc.m2", 1,
					   1);
			add_button("Disc 777 radius", "world/scale/777yardradiusdisc.m2", 1,
					   2);
			add_button("Sphere 50 radius", "world/scale/50yardradiussphere.m2",
					   1, 3);
			add_button("Sphere 200 radius",
					   "world/scale/200yardradiussphere.m2", 1, 4);
			add_button("Sphere 777 radius",
					   "world/scale/777yardradiussphere.m2", 1, 5);
		}
	}  // namespace ui
}  // namespace noggit
